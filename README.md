...
An event-driven, near real-time data pipeline for employee records.
It ingests data via REST API, validates and routes events through AWS streaming infrastructure,
auto-loads data into Snowflake, and applies SCD Type 1 logic using Snowflake Streams and Tasks.
